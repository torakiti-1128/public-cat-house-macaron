...
import { KittenDetailType, KittensType, ParentCatDetailType, ParentCatsType } from '@/types/types';
import {
    deleteParentCat,
...
import { deleteKitten, fetchKittenDetail, postKitten, updateKitten } from '@/api/kittensApi';
...
const Kittens: React.FC<KittensProps> = ({
    kittens,
    getKittens,
}) => {
    ...
    return (
        <div className="container mx-auto pt-20 p-4">
            <h1 className="text-3xl font-bold mb-6 text-center">子猫管理サイト</h1>
